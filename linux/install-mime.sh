...
xdg-mime install --novendor 'mime/goldsrc-rmf.xml'
...
xdg-icon-resource install --context mimetypes --size 64 'mime/icon/goldsrc-rmf_64x.png' 'application-goldsrc-rmf'
